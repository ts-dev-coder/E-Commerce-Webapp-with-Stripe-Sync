...
class SalesRepositoryTest extends TestCase
{
    ...
    public function test_it_excludes_data_before_start_by_one_second()
    {
        // 範囲外
        Order::factory()->create([
            'total_amount' => 1000,
            'created_at' => Carbon::now()->startOfDay()->subSecond(),
        ]);
        ...
        $this->assertEquals(2000, $result, 'Expected sales data to be 2000 for the default date range');
    }

    public function test_it_excludes_data_after_end_by_one_second()
    {
        // 範囲内
        Order::factory()->create([
            'total_amount' => 2000,
        ...
        Order::factory()->create([
            'total_amount' => 5000,
            'created_at' => Carbon::now()->endOfDay()->addSecond(),
        ]);
    ...
    public function test_it_counts_sales_regardless_of_time_within_the_day()
    {
        Order::factory()->create([
            'total_amount' => 1000,
            'created_at' => Carbon::now()->setTime(1, 0, 0),
        ]);
        Order::factory()->create([
            'total_amount' => 2000,
            'created_at' => Carbon::now()->setTime(15, 30, 0),
        ]);
        Order::factory()->create([
            'total_amount' => 3000,
            'created_at' => Carbon::now()->setTime(23, 59, 59),
